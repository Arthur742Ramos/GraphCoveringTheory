...
theorem graphEdgeInteriorPre_isOpen {V : Type u} [Quiver.{u} V]
  ...
  · rw [isOpen_sigma_iff]
    ...
    · subst h
      ...
      simp only [true_and]
      exact isOpen_Ioo
    · simpa [graphEdgeInteriorPre, h] using
        (isOpen_empty : IsOpen (∅ : Set I))
...
theorem graphRealization_vertex_edge_source {V : Type u} [Quiver.{u} V]
  ...
  have hl := congrArg graphRealizationEndpointLabelQuotient h
  simp [graphRealizationEndpointLabelQuotient_mk,
    graphRealizationEndpointLabel, ht] at hl
  exact hl
...
instance graphCoverVertexOver_topology {V : Type u} [Quiver.{u} V]
...
theorem graphCoverRealizationProjection_vertexStar_injective
  ...
  | inl av =>
      ...
      | inl bv =>
          ...
          have hv : graphVertexUnderlying av = graphVertexUnderlying bv :=
            hav.trans hbv.symm
      ...
      | inr bz =>
          ...
          have ezero :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge e, 0⟩) =
                graphRealizationQuotient
                  (Sum.inl (graphDiscreteVertex e.left)) := by
            exact graphEdgePath_zero e
          have eone :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge e, 1⟩) =
                graphRealizationQuotient
                  (Sum.inl (graphDiscreteVertex e.right)) := by
            exact graphEdgePath_one e
          have hbz : bz = graphDiscreteEdge e := by
            simpa [e, graphDiscreteEdge, graphEdgeUnderlying] using
              (WithTopology.toTopology_ofTopology bz).symm
          rw [hbz]
              ...
              graphRealizationQuotient (Sum.inl (graphDiscreteVertex
                  ...
                  graphRealizationQuotient (Sum.inl (graphDiscreteVertex e.left)) := by
                    exact congrArg (fun z : graphCoverVertex root =>
                      graphRealizationQuotient
                        (Sum.inl (graphDiscreteVertex z)))
                      (hav.trans hes.symm)
              _ = graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, 0⟩) := ezero.symm
              _ = graphRealizationQuotient (Sum.inr
              ...
              graphRealizationQuotient (Sum.inl (graphDiscreteVertex
                  ...
                  graphRealizationQuotient (Sum.inl (graphDiscreteVertex e.right)) := by
                    exact congrArg (fun z : graphCoverVertex root =>
                      ...
                      (hav.trans het.symm)
              _ = graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, 1⟩) := eone.symm
              _ = graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, t⟩) := by rw [ht]
  | inr az =>
      rcases az with ⟨az, t⟩
      ...
      | inl bv =>
          ...
          have haz : az = graphDiscreteEdge e := by
            simpa [e, graphDiscreteEdge, graphEdgeUnderlying] using
              (WithTopology.toTopology_ofTopology az).symm
          rw [haz]
          rcases graphRealization_vertex_edge_endpoint hbase' with ht | ht
          · have hes : e.left = x.1 := by
            ...
            calc
              graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, t⟩) =
                  graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, 0⟩) := by rw [ht]
              _ = graphRealizationQuotient (Sum.inl (graphDiscreteVertex e.left)) :=
                ezero
              _ = graphRealizationQuotient (Sum.inl (graphDiscreteVertex
                  (graphVertexUnderlying bv))) := by
                    exact congrArg (fun z : graphCoverVertex root =>
                      graphRealizationQuotient
                        (Sum.inl (graphDiscreteVertex z)))
                      (hes.trans hbv.symm)
          · have het : e.right = x.1 := by
            ...
            calc
              graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, t⟩) =
                  graphRealizationQuotient (Sum.inr
                  ⟨graphDiscreteEdge e, 1⟩) := by rw [ht]
      ...
      | inr bz =>
          ...
          have ezero (d : Quiver.Total (graphCoverVertex root)) :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge d, 0⟩) =
                graphRealizationQuotient
                  (Sum.inl (graphDiscreteVertex d.left)) := by
            exact graphEdgePath_zero d
          have eone (d : Quiver.Total (graphCoverVertex root)) :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge d, 1⟩) =
                graphRealizationQuotient
                  (Sum.inl (graphDiscreteVertex d.right)) := by
            exact graphEdgePath_one d
          have bezero (d : Quiver.Total V) :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge d, 0⟩) =
                graphRealizationQuotient
                  (Sum.inl (graphDiscreteVertex d.left)) := by
            exact graphEdgePath_zero d
          have beone (d : Quiver.Total V) :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge d, 1⟩) =
                graphRealizationQuotient
                  (Sum.inl (graphDiscreteVertex d.right)) := by
            exact graphEdgePath_one d
          let eb : Quiver.Total V :=
            ⟨e.left.1, e.right.1, e.hom.1⟩
          let fb : Quiver.Total V :=
            ⟨f.left.1, f.right.1, f.hom.1⟩
          have hbase'' :
              graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge eb, t⟩) =
                graphRealizationQuotient
                  (Sum.inr ⟨graphDiscreteEdge fb, t'⟩) := by
            simpa [eb, fb] using hbase'
          have haz : az = graphDiscreteEdge e := by
            simpa [e, graphDiscreteEdge, graphEdgeUnderlying] using
              (WithTopology.toTopology_ofTopology az).symm
          have hbz : bz = graphDiscreteEdge f := by
            simpa [f, graphDiscreteEdge, graphEdgeUnderlying] using
              (WithTopology.toTopology_ofTopology bz).symm
          rw [haz, hbz]
          by_cases ht0 : t = 0
          · have hvertex :
                graphRealizationQuotient (Sum.inl (graphDiscreteVertex eb.left)) =
                  graphRealizationQuotient (Sum.inr ⟨graphDiscreteEdge
                    fb, t'⟩) := by
                have hbase0 :
                    graphRealizationQuotient
                        (Sum.inr ⟨graphDiscreteEdge eb, 0⟩) =
                      graphRealizationQuotient
                        (Sum.inr ⟨graphDiscreteEdge fb, t'⟩) := by
                  simpa [ht0] using hbase''
                exact (bezero eb).symm.trans hbase0
            rcases graphRealization_vertex_edge_endpoint hvertex with ht'0 | ht'1
            · have he : e.left = x.1 := by
                rcases ha₀ with ha₀ | ha₀
                · exact ha₀.1
                · exfalso
                  exact (not_lt_of_ge (le_of_lt graphHalf_pos)) (ht0 ▸ ha₀.2)
              have hf : f.left = x.1 := by
                rcases hb₀ with hb₀ | hb₀
                · exact hb₀.1
                · exfalso
                  exact (not_lt_of_ge (le_of_lt graphHalf_pos)) (ht'0 ▸ hb₀.2)
              calc
                graphRealizationQuotient (Sum.inr ⟨graphDiscreteEdge e, t⟩) =
                    graphRealizationQuotient (Sum.inl (graphDiscreteVertex x.1)) := by
                      rw [ht0]
                      exact (ezero e).trans (congrArg graphVertex he)
                _ = graphRealizationQuotient (Sum.inr
                    ⟨graphDiscreteEdge f, t'⟩) := by
                      rw [ht'0]
                      exact (congrArg graphVertex hf.symm).trans (ezero f).symm
            · have he : e.left = x.1 := by
                rcases ha₀ with ha₀ | ha₀
                · exact ha₀.1
                · exfalso
              ...
              have hf : f.right = x.1 := by
                rcases hb₀ with hb₀ | hb₀
                · exfalso
                  exact (not_lt_of_ge (le_of_lt graphHalf_lt_one)) (ht'1 ▸ hb₀.2)
                · exact hb₀.1
              calc
                graphRealizationQuotient (Sum.inr ⟨graphDiscreteEdge e, t⟩) =
                    graphRealizationQuotient (Sum.inl (graphDiscreteVertex x.1)) := by
                ...
                _ = graphRealizationQuotient (Sum.inr
                    ⟨graphDiscreteEdge f, t'⟩) := by
                      rw [ht'1]
                      exact (congrArg graphVertex hf.symm).trans (eone f).symm
          · by_cases ht1 : t = 1
            · have hvertex :
                  ...
                  have hbase1 :
                      graphRealizationQuotient
                          (Sum.inr ⟨graphDiscreteEdge eb, 1⟩) =
                        graphRealizationQuotient
                          (Sum.inr ⟨graphDiscreteEdge fb, t'⟩) := by
                    simpa [ht1] using hbase''
                  exact (beone eb).symm.trans hbase1
              rcases graphRealization_vertex_edge_endpoint hvertex with ht'0 | ht'1
              · have he : e.right = x.1 := by
                  rcases ha₀ with ha₀ | ha₀
                  · exfalso
                    exact (not_lt_of_ge (le_of_lt graphHalf_lt_one)) (ht1 ▸ ha₀.2)
                  · exact ha₀.1
                have hf : f.left = x.1 := by
                  rcases hb₀ with hb₀ | hb₀
                  · exact hb₀.1
                ...
                calc
                  graphRealizationQuotient (Sum.inr ⟨graphDiscreteEdge e, t⟩) =
                      graphRealizationQuotient (Sum.inl (graphDiscreteVertex x.1)) := by
                        rw [ht1]
                        exact (eone e).trans (congrArg graphVertex he)
                  _ = graphRealizationQuotient (Sum.inr
                      ⟨graphDiscreteEdge f, t'⟩) := by
                        rw [ht'0]
                        exact (congrArg graphVertex hf.symm).trans (ezero f).symm
            ...
            · have ht0' : 0 < t := lt_of_le_of_ne t.2.1 (Ne.symm ht0)
              ...
              have ht0ne : t' ≠ 0 := by
                intro ht'
                have hl := graphRealization_eqvGen_interiorLabel
                  (Quotient.exact hbase'')
              ...
              have heq := graphRealization_interior_eqvGen_eq
                ht0' ht1' (by
                  exact lt_of_le_of_ne t'.2.1 (Ne.symm ht0ne))
                (by
                  exact lt_of_le_of_ne t'.2.2 ht1ne)
                (Quotient.exact hbase'')
              have hteq : t = t' := heq.2
              have hside : t < graphHalf ∨ graphHalf < t := by
                rcases ha₀ with ha₀ | ha₀
                · exact Or.inl ha₀.2
                · exact Or.inr ha₀.2
              ...
              · have he : e.left = x.1 := by
                  ...
                  · exact ha₀.1
                  · exfalso
                    exact (not_lt_of_ge (le_of_lt hside)) ha₀.2
                have hf : f.left = x.1 := by
                  rcases hb₀ with hb₀ | hb₀
                  · exact hb₀.1
                  · exfalso
                    exact (not_lt_of_ge (le_of_lt hside))
                      (hteq ▸ hb₀.2)
                let se : Quiver.Star x.1 := ⟨e.right, he ▸ e.hom⟩
                let sf : Quiver.Star x.1 := ⟨f.right, hf ▸ f.hom⟩
                have hstar :
                    se = sf := by
                  apply (graphCoverStarEquiv root x.1).injective
                  simpa [se, sf] using
                    (graphCoverStarEquiv_map_eq_of_total_eq x.1 e f he hf heq.1)
                have hedge : e = f := by
                  exact graphCover_total_eq_of_star_eq x.1 e f he hf (by
                    simpa [se, sf, he, hf] using hstar)
                simpa [hedge, hteq]
              · have he : e.right = x.1 := by
                  rcases ha₀ with ha₀ | ha₀
                  · exfalso
                ...
                have hf : f.right = x.1 := by
                  ...
                  · exfalso
                    exact (not_lt_of_ge (le_of_lt hside))
                      (hteq ▸ hb₀.2)
                  · exact hb₀.1
                let ce : Quiver.Costar x.1 := ⟨e.left, he ▸ e.hom⟩
                let cf : Quiver.Costar x.1 := ⟨f.left, hf ▸ f.hom⟩
                have hcostar :
                    ce = cf := by
                  apply (graphCoverCostarEquiv root x.1).injective
                  simpa [ce, cf] using
                    (graphCoverCostarEquiv_map_eq_of_total_eq x.1 e f he hf heq.1)
                have hedge : e = f := by
                  exact graphCover_total_eq_of_costar_eq x.1 e f he hf (by
                    simpa [ce, cf, he, hf] using hcostar)
                simpa [hedge, hteq]
...
theorem graphCoverRealizationProjection_vertexStar_surjective
  ...
  | inr z =>
      ...
      have hze : ze = graphDiscreteEdge e := by
        simpa [e, graphDiscreteEdge, graphEdgeUnderlying] using
          (WithTopology.toTopology_ofTopology ze).symm
      rw [hze] at hzy
      ...
      · rw [isOpen_sigma_iff]
        ...
        have hsource_open :
          ...
          · have hempty : {t : I |
              ...
              · intro ht
                exact False.elim (by simpa using ht)
            rw [hempty]
            exact isOpen_empty
        have htarget_open :
...
instance graphCoverEdgeOver_topology {V : Type u} [Quiver.{u} V]
  ...
  · intro hz
    ...
    | inl zv =>
        have hfalse : False := by
          simpa [graphRealizationPreMap, graphCoverProjection,
            graphEdgeInteriorPre] using hpre
        exact hfalse.elim
    | inr z =>
        rcases z with ⟨ze, t⟩
        ...
        have hpre' : graphCoverEdgeProjection root d = e ∧
          ...
          simpa [graphRealizationPreMap, graphCoverProjection,
            ...
            graphCoverEdgeProjection, d] using hpre
        refine Set.mem_iUnion.mpr ⟨⟨d, hpre'.1⟩, ?_⟩
        refine ⟨Sum.inr ⟨graphDiscreteEdge d, t⟩, ?_, ?_⟩
        · have hmem :
              graphDiscreteEdge (d : Quiver.Total (graphCoverVertex root)) =
                graphDiscreteEdge (d : Quiver.Total (graphCoverVertex root)) ∧
                  t ∈ Ioo (0 : I) 1 :=
            ⟨rfl, hpre'.2⟩
          simpa [graphEdgeInteriorPre] using hmem
        · rfl
  · intro hz
    ...
    change graphCoverRealizationProjection root
        (graphRealizationQuotient z) ∈ graphEdgeInterior e
...
theorem graphCoverRealizationProjection_isCovering
  ...
  have hvertex : ∀ v : V,
    ...
    intro v
    letI : Nonempty (graphCoverVertexOver root v) :=
      graphCoverVertexOver_nonempty root v
    letI : Nonempty (graphCoverRealization root) := by
  ...
  have hedge : ∀ (e : Quiver.Total V) {y : graphRealization V},
    ...
    intro e y hy
    letI : Nonempty (graphCoverEdgeOver root e) :=
  ...
  | inl v =>
      have hv : graphRealizationQuotient (Sum.inl v) =
        ...
        have hv' : v = graphDiscreteVertex (graphVertexUnderlying v) := by
          simpa [graphDiscreteVertex, graphVertexUnderlying] using
            (WithTopology.toTopology_ofTopology v).symm
        calc

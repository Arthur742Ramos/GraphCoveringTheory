...
theorem graphCoverSymmetricFreeGroupoidMap_endpoint {root : V}
  ...
  | inr e =>
      calc
        z.2 = (z.2 ≫ (Quiver.FreeGroupoid.of V).map e.1) ≫
            Groupoid.inv ((Quiver.FreeGroupoid.of V).map e.1) := by
          simp [Category.assoc]
        _ = y.2 ≫ Groupoid.inv ((Quiver.FreeGroupoid.of V).map e.1) := by
          rw [e.property]
        _ = y.2 ≫ (graphCoverSymmetricFreeGroupoidMap root).map (Sum.inr e) := by
          rfl
...
abbrev singleObjHomValue {M : Type u} [Monoid M]
      ...
      | @cons d b q f =>
          ...
          · intro hbase
            ...
            have hopp : (coverSymEdgeLetter e).2 =
                !(coverSymEdgeLetter f).2 := by
              cases he : (coverSymEdgeLetter e).2 <;>
                cases hf : (coverSymEdgeLetter f).2 <;> simp_all
...
theorem coverFreeGroupValue_nil {root : V} (x : graphCoverVertex root) :
  ...
  simp [coverFreeGroupValue, coverSymPathValue, CategoryTheory.Paths.lift_nil]
...
theorem coverFreeGroupValue_eq_word {root : V}
  ...
  induction p using
      (@Quiver.Path.rec (Symmetrify (graphCoverVertex root))
        (Quiver.symmetrifyQuiver (graphCoverVertex root))) with
  | nil =>
      simp [coverFreeGroupValue_nil, coverSymPathWord]
...
noncomputable def graphCoverSymmetricTree {V : Type u} [Quiver.{u} V]
  ...
  letI : @RootedConnected (Symmetrify (graphCoverVertex root))
      (Quiver.symmetrifyQuiver (graphCoverVertex root))
...
def graphCoverTreeEdgeChoiceProperty {V : Type u} [Quiver.{u} V]
    [WeaklyConnected V] (root : V) (e : Quiver.Total (graphCoverVertex root))
...
theorem graphCoverTreeFoldCoordinate_positive {V : Type u} [Quiver.{u} V]
    [WeaklyConnected V] (root : V) {a b : graphCoverVertex root}
...
theorem graphCoverTreeFold_h0 {V : Type u} [Quiver.{u} V]
    [WeaklyConnected V] (root : V) (d : Quiver.Total (graphCoverSymmetricTree root)) :
    graphRealizationQuotient
...
theorem graphCoverTreeToCover_vertex {V : Type u} [Quiver.{u} V]
    [WeaklyConnected V] (root : V) (v : graphCoverSymmetricTree root) :
...
def graphCoverVertexEmbed {V : Type u} [Quiver.{u} V]
    [WeaklyConnected V] (root : V) (v : graphCoverVertex root) :
...
theorem graphCoverTreeEdgeBase_injective
  ...
  letI : @RootedConnected (Symmetrify (graphCoverVertex root))
      (Quiver.symmetrifyQuiver (graphCoverVertex root))
      (graphCoverRootVertex root) := graphCoverSymmetric_rootedConnected root
  letI : @Quiver.Arborescence (graphCoverSymmetricTree root)
...
theorem graphCoverRealization_fiber_vertex
  ...
  | inr z =>
      ...
      have hzproj : graphEdgePath
        ...
        exact hz
      have ht : t = 0 ∨ t = 1 := by
        apply graphRealization_vertex_edge_endpoint (V := V)
        change graphRealizationQuotient (Sum.inl (graphDiscreteVertex root)) =
...
theorem graphCombinatorialToTopological_injective
  ...
  intro q heq
  have htop : Path.Homotopic.Quotient.mk
      (@graphRealizationQuiverPath V _ _ _ p) =
      Path.Homotopic.Quotient.mk
        (@graphRealizationQuiverPath V _ _ _ q) := by
    change (graphFreeGroupoidToTopological (V := V)).map
        (Quot.mk _ p) =
